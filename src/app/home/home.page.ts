...
export class HomePage {
  ...
  addToMyProduct(){
    ...
    if(this.productCounter == 1){
      this.myProduct.push({"buyLastWeek":"true" ,"name": "Tomate", "url": "https://fac.img.pmdstatic.net/fit/http.3A.2F.2Fprd2-bone-image.2Es3-website-eu-west-1.2Eamazonaws.2Ecom.2Ffac.2F2020.2F07.2F01.2F87b07c44-7505-4f0b-b5ab-dea24d5d7521.2Ejpeg/750x562/quality/80/crop-from/center/cr/wqkgVW5zcGxhc2ggLyBGZW1tZSBBY3R1ZWxsZQ%3D%3D/quels-sont-les-bienfaits-de-la-tomate.jpeg"})
      this.buyLastWeek.push({"buyLastWeek":"true" ,"name": "Tomate", "url": "https://fac.img.pmdstatic.net/fit/http.3A.2F.2Fprd2-bone-image.2Es3-website-eu-west-1.2Eamazonaws.2Ecom.2Ffac.2F2020.2F07.2F01.2F87b07c44-7505-4f0b-b5ab-dea24d5d7521.2Ejpeg/750x562/quality/80/crop-from/center/cr/wqkgVW5zcGxhc2ggLyBGZW1tZSBBY3R1ZWxsZQ%3D%3D/quels-sont-les-bienfaits-de-la-tomate.jpeg"})
    } else if(this.productCounter == 2){
      this.myProduct.push({"buyLastWeek":"false" ,"name": "Cereales", "url": "https://www.carrefour.fr/media/1500x1500/Photosite/PGC/EPICERIE/3421557501890_PHOTOSITE_20200812_102049_0.jpg?placeholder=1"})
    } else if(this.productCounter == 3){
      this.myProduct.push({"buyLastWeek":"false" ,"name": "Boeuf", "url": "https://barakashop.fr/wp-content/uploads/2018/11/entrecote.jpg"})
    } else if(this.productCounter == 4){
      this.myProduct.push({"buyLastWeek":"true" ,"name": "Champignon", "url": "https://cuisine-test.com/wp-content/uploads/2019/02/comment-cuisiner-des-champignons-de-paris-930x620.jpg"})
      this.buyLastWeek.push({"buyLastWeek":"true" ,"name": "Champignon", "url": "https://cuisine-test.com/wp-content/uploads/2019/02/comment-cuisiner-des-champignons-de-paris-930x620.jpg"});
    } else if(this.productCounter == 5){
      this.myProduct.push({"buyLastWeek":"false" ,"name": "Carotte", "url": "https://lh3.googleusercontent.com/proxy/SB_AWcN-5fDnRcZpKwkdp8QPakJS89IxmTI_3091gTlhc2_kzhYxT5yXVsRVKYIYUYvFLOPtI2SRsCFRyzCIvu8TGUugK0-fw3akazQ-Co-CU-bs"})
    } else {
      this.myProduct.push({"buyLastWeek":"true" ,"name": "Other Product", "url": "url.html"})
    }
